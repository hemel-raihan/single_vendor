...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $product = Product::create([
            ...
            //'variant_product' => $request->unit_price,
    ...
    public function add_more_choice_option(Request $request) {
        ...
        foreach ($all_attribute_values as $key=> $row) {
            ...
            $html .= '<li class="transfer-double-group-list-li transfer-double-group-list-li-1636878492751">
            <div class="checkbox-group">
                <input type="checkbox" name="choice_options_'.$row->attribute->id.'[]" value="'.$row->value.'" class="attribute_choice checkbox-normal group-select-all-1636878492751" id="group_'.$key.'_1636878492751" /><label for="group_'.$key.'_1636878492751" class="group-name-1636878492751">'.$row->value.'</label>
            </div>
        </li>';
        }
