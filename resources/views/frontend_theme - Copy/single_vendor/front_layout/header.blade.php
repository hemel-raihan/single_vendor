                        ...
                        <div class="dropdownmenu-wrapper custom-scrollbar">
                            ...
                            <div class="dropdown-cart-products">
                                <div class="product">
                                    ...
                                    <figure class="product-image-container">
                                        <a href="demo42-product.html" class="product-image">
                                            <img src="{{ asset('single_vendor/assets/images/products/product-1.jpg') }}" alt="product"
                                                width="80" height="80">
                                        </a>
                                ...
                                <div class="product">
                                    ...
                                    <figure class="product-image-container">
                                        <a href="demo42-product.html" class="product-image">
                                            <img src="{{ asset('single_vendor/assets/images/products/product-2.jpg') }}" alt="product"
                                                width="80" height="80">
                                        </a>
                                ...
                                <div class="product">
                                    ...
                                    <figure class="product-image-container">
                                        <a href="demo42-product.html" class="product-image">
                                            <img src="{{ asset('single_vendor/assets/images/products/product-3.jpg') }}" alt="product"
                                                width="80" height="80">
                                        </a>
                                        <a href="#" class="btn-remove" title="Remove Product"><span>×</span></a>
                                    </figure>
