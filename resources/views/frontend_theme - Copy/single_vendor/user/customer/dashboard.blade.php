                ...
                <table class="table table-order text-left">
                    <thead>
                        <tr>
                            ...
                            <th class="order-price">Delivery Status</th>
                            <th class="order-price">Payment Status</th>
                    ...
                    <tbody>
                        <tr class="product-row">
                            ...
                            <td>unpaid</td>
                            <td class="action">
                                <a href="javascript:void(0)" class="btn btn-soft-info btn-icon btn-circle btn-sm" onclick="show_purchase_history_details(2)" title="{{ translate('Order Details') }}">
                                    <i class="fa fa-eye"></i>
                                </a>
