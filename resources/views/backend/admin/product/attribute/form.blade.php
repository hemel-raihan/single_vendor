...
@section('content')
						...
						<div class="page-header">
							<div>
								<h1 class="page-title">{{ isset($attribute) ? 'Edit ' : 'Create '}}Attribute</h1>
								{{-- <ol class="breadcrumb">
							...
							<div class="ms-auto pageheader-btn">
								<a href="{{route('admin.attributes.index')}}" class="btn btn-primary btn-icon text-white me-2">
									<span>
										{{-- <i class="fe fe-minus"></i> --}}
									</span> Back To AttributeList
								</a>
                   ...
                   <!-- ROW-1 OPEN -->
    <form method="POST" action="{{isset($attribute) ? route('admin.attributes.update',$attribute->id) : route('admin.attributes.store')}}" enctype="multipart/form-data">
    @csrf
    @isset($attribute)
    @method('PUT')
    @endisset
		...
		<div class="col-lg-9 col-xl-9 col-md-12 col-sm-12">
			<div class="card">
				...
				<div class="card-footer text-end">
					...
					<a href="{{route('admin.attributes.index')}}" class="btn btn-danger mt-1">Cancel</a>
				</div>
			</div>
		</div>
