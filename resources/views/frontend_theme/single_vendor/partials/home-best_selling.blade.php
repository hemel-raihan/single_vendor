<section class="brand-section appear-animate" style="background-color: #f4f4f4;">
    <div class="container">
        <h2 class="title title-underline pb-1 appear-animate" data-animation-name="fadeInLeftShorter">Top Selling</h2>
        <div class="owl-carousel owl-theme nav-big nav-outer appear-animate" data-owl-options="{
                ...
                @php
                  $products=\App\Models\Product\Product::where('status',1)->orderBy('num_of_sale','desc')->get();
                @endphp
