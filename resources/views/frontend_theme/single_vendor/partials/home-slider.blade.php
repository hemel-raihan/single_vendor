<div class="intro-slider slide-animate owl-carousel owl-theme show-nav-hover nav-inside nav-big"
    ...
    <div class="banner intro-slide1" style="background: url('{{ asset('single_vendor/assets/images/demoes/demo42/slider/slide1.jpg') }}') rgb(255, 255, 255);
        ...
        <div class="container">
            ...
            <div class="row h-100">
                ...
                <div class="col-md-5 banner-media appear-animate d-none d-md-block"
                    ...
                    <img src="{{ asset('single_vendor/assets/images/demoes/demo42/banner2.jpg') }}" width="504" height="347"
                        alt="banner" />
                    <div class="mark-deal"><i>%
                            Deal</i></div>
                </div>
