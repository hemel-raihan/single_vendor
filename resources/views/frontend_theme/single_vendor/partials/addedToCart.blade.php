<div class="modal-body p-4 added-to-cart">
    ...
    {{-- <div class="media mb-4">
        <img src="{{ asset('uploads/productphoto/'.$product->image) }}" data-src="{{ asset('uploads/productphoto/'.$product->image) }}" class="mr-3 lazyload size-100px img-fit rounded" alt="Product Image">
