...
<div class="twelve columns" id="left-content">
    ...
    <div id="printable_area">
        ...
        <a href="{{ asset('uploads/files/'.$notice->files) }}">
            <img src="{{ asset('frontend/images/pdf.png') }}" alt="001-converted (1)_compressed (1).pdf" class="file-icon" />{{ $notice->files }}
        </a>
        <div><a class="viewer" href="{{ asset('uploads/files/'.$notice->files) }}"></a></div>
        <style></style>
        <script></script>
    </div>
